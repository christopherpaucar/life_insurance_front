...
export const INSURANCE_QUERY_KEYS = {
  ...
  coverages: (insuranceId: string) =>
    [...INSURANCE_QUERY_KEYS.detail(insuranceId), 'coverages'] as const,
  coverage: (insuranceId: string, id: string) =>
    [...INSURANCE_QUERY_KEYS.coverages(insuranceId), id] as const,
  benefits: (insuranceId: string) =>
    [...INSURANCE_QUERY_KEYS.detail(insuranceId), 'benefits'] as const,
  benefit: (insuranceId: string, id: string) =>
    [...INSURANCE_QUERY_KEYS.benefits(insuranceId), id] as const,
}
...
export const useInsuranceCoverages = (insuranceId: string) => {
  ...
  const createCoverageMutation = useMutation({
    mutationFn: (data: CreateInsuranceCoverageDto) =>
      insurancesService.createCoverage(insuranceId, data),
    onSuccess: () => {
      void queryClient.invalidateQueries({ queryKey: INSURANCE_QUERY_KEYS.coverages(insuranceId) })
...
export const useInsuranceBenefits = (insuranceId: string) => {
  ...
  const createBenefitMutation = useMutation({
    mutationFn: (data: CreateInsuranceBenefitDto) =>
      insurancesService.createBenefit(insuranceId, data),
    onSuccess: () => {
      void queryClient.invalidateQueries({ queryKey: INSURANCE_QUERY_KEYS.benefits(insuranceId) })
